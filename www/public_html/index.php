...
<head>
    ...
    <title>Docker AMP+R Stack</title>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a href="https://github.com/Nathan-LancashireCloud/Docker-AMP-R" 
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-center mb-5 fade-in">
                    <h1 class="display-4 mb-3">Welcome to your AMP-R Stack</h1>
                    <p class="lead text-muted">Apache + MySQL + PHP + Redis on Docker</p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <!-- Redis Status -->
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm status-card" data-tooltip="Redis Connection Status">
                            <div class="card-body text-center">
                                <i class="fas fa-memory icon-large <?php echo $redis ? 'connected' : 'error'; ?>"></i>
                                <h5 class="card-title">Redis</h5>
                                <p class="card-text"><?php echo $redis ? 'Connected' : 'Disconnected'; ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center mt-5 fade-in">
                    <p class="text-muted">
                        <small>
                            Developed with <i class="fas fa-heart text-danger footer-heart"></i>
                        </small>
                    </p>
                </div>
            </div>
